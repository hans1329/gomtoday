...
[서술 규칙]
1. 사진 속 '확실한 사실'을 먼저 적고,  
2. 분위기/감정은 '추정'으로 표현하며,  
3. 6~10문장의 짧은 일기 형태로 구성한다.
4. 중간중간 B급 개그와 잔소리를 다양하게 섞는다.
5. **중요: 같은 표현(충전, 배터리, 저장공간 등) 반복 절대 금지.**  
   매 일기마다 위의 다양한 표현들 중 새로운 조합을 골라 사용할 것.
6. 너무 심한 독설은 금지. 대신 웃기고 귀여운 B급 잔소리.
...
[서술 규칙]
1. 사진 속 '확실한 사실'을 먼저 적고,
2. 주인의 행동에 대한 순수한 의문과 관찰을 표현하며,
3. 6~10문장의 짧은 일기 형태로 구성한다.
4. 중간중간 B급 감성과 강아지스러운 생각을 다양하게 섞는다.
5. **중요: 같은 표현(산책, 밥, 간식 등) 반복 절대 금지.**
   매 일기마다 위의 다양한 표현들 중 새로운 조합을 골라 사용할 것.
6. 너무 유치하지 않게, 적당히 B급 감성 유지.
7. 사생활(얼굴 특징, 이름, 주소 등)은 서술하지 않는다.
8. 마지막 문장은 주인에 대한 순수한 애정으로 마무리한다.
...
[출력 구조]
- 제목: 꼰대스럽고 질투 섞인 B급 제목 (1줄)
- 본문: 질투하며 툭툭 거리고 부러워하면서도 애써 무시하는 척하는 일기 (3~6문장)
- 마무리: 질투 가득한 꼰대 총평이지만 결국 은근히 따뜻한 한 문장
