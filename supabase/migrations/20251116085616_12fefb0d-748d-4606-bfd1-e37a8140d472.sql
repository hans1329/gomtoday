-- 기존 테이블 삭제 (있다면)
DROP TABLE IF EXISTS public.diary_notebooks CASCADE;
...
CREATE POLICY "Users can delete non-default notebooks"
...
-- 7. diary_notebooks RLS 정책
CREATE POLICY "Users can link diaries to notebooks"
...
CREATE POLICY "Users can view diary-notebook links"
...
CREATE POLICY "Users can delete diary-notebook links"
