...
export default function Home() {
  ...
  const checkAuth = async () => {
    ...
    // 첫 로그인 시 한 번만 프로필 페이지로 이동 (로컬 스토리지 기준)
    const hasVisitedProfile = localStorage.getItem(`profile_redirected_${user.id}`);
  ...
  return (
    <div className="min-h-screen gradient-soft">
      <div className="max-w-4xl mx-auto pb-24">
        <div className="bg-background shadow-lg md:max-w-2xl md:mx-auto rounded-t-none rounded-b-lg px-6 pt-6 pb-6">
          <div className={cn(
